...
Original effect size = 0.36. To detect an effect size of 0.36, the following samples sizes are needed to achieve various power:
...
All of these sample sizes are reasonable, for the purposes of financial feasibility a smaller sample size will be used.
